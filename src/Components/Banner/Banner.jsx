...
const Banner = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      ...
      <input type="text" name="" placeholder="Search with post tags" id="" className="bg-cyan-200 text-black px-[45px] md:px-[70px] lg:px-[70px] py-[11px] rounded-[4px] md:mr-[10px]" />
